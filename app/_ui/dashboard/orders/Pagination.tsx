...
import { ChangeValuePageProduct } from "@/redux/slices/CounterSlice";

const PaginationOrders = ({ totalPage }: { totalPage: number }) => {
  const dispatch = useAppDispatch();
  const { page } = useAppSelector((state) => state.cart);
